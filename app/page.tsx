  ...
  return (
    <div className="w-full h-screen bg-gray-900 flex flex-col">
      ...
      <div className="flex-1 flex">
        ...
        <div className="w-1/2 bg-gray-900 flex flex-col items-center justify-center relative">
          ...
          <div className="text-center mt-8">
            ...
            <p className="text-gray-400 text-sm mt-2">{isPlaying ? "Audio response playing" : "Click play to start"}</p>
          </div>
